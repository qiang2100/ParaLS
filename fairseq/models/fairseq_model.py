...
class BaseFairseqModel(nn.Module):
    ...
    def load_state_dict(
        ...
        #     if "encoder.layernorm_embedding.weight" in new_state_dict:
        #         new_state_dict.pop("encoder.layernorm_embedding.weight")
        #     if "encoder.layernorm_embedding.bias" in new_state_dict:
        #         new_state_dict.pop("encoder.layernorm_embedding.bias")
        #     if "decoder.layernorm_embedding.weight" in new_state_dict:
        #         new_state_dict.pop("decoder.layernorm_embedding.weight")
        #     if "decoder.layernorm_embedding.bias" in new_state_dict:
        #         new_state_dict.pop("decoder.layernorm_embedding.bias")
        return super().load_state_dict(new_state_dict, strict)
