...
class FairseqTask(object):
    ...
    def inference_step2(
        self, generator, models, sample, prefix_tokens=None, attn_len=None,tgt_token=None,suffix_ids=None, max_aheads=None,constraints=None
    ):
        
        with torch.no_grad():
            return generator.generate2(
                models, sample, prefix_tokens=prefix_tokens, attn_len=attn_len,tgt_token=tgt_token,suffix_ids=suffix_ids, max_aheads=max_aheads,constraints=constraints
            )
