...
class BERTScorer:
    ...
    def comput_sis(self, candidate, reference, fname=""):
        ...
        r_tokens = [token.strip() for token in r_tokens]
        h_tokens = [token.strip() for token in h_tokens]
